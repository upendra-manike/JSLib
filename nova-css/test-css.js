...
const cssPath = path.join(__dirname, 'dist', 'nova.css');

console.log('🧪 Testing NovaCSS...\n');

// Read the CSS file
if (!fs.existsSync(cssPath)) {
  console.error('❌ Error: dist/nova.css not found. Run "npm run build" first.');
  process.exit(1);
}
